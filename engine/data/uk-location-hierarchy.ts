  ...
  },
  {
    ...
    counties: [
      ...
      { countyName: "Surrey", countySlug: "surrey", locationIds: ["epsom", "esher", "guildford", "leatherhead", "reigate", "staines", "weybridge", "woking"] },
      {
        ...
        locationIds: ["brighton", "crowborough", "eastbourne", "hastings", "lewes", "uckfield"],
      },
      {
        countyName: "West Sussex",
        countySlug: "west-sussex",
        locationIds: ["burgess-hill", "chichester", "crawley", "east-grinstead", "haywards-heath", "horsham", "worthing"],
      },
      { countyName: "Berkshire", countySlug: "berkshire", locationIds: ["cookham", "maidenhead", "reading", "slough"] },
  ...
  },
  {
    ...
    counties: [
      ...
      { countyName: "Cambridgeshire", countySlug: "cambridgeshire", locationIds: ["cambridge", "peterborough"] },
      {
        ...
        locationIds: ["ampthill", "bedford", "biggleswade", "dunstable", "flitwick", "leighton-buzzard", "luton", "sandy"],
      },
