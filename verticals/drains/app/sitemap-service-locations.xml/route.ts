...
import { generateDrainsServiceLocationStaticParams } from "@/lib/alignedTerritoryGeneration";
...
export async function GET() {
  ...
  for (const { serviceSlug, locationSlug } of generateDrainsServiceLocationStaticParams(
    locations,
    services
  )) {
    entries.push({
