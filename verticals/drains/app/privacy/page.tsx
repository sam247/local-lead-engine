...
export const metadata: Metadata = {
  ...
  description: `How ${verticalConfig.siteName} collects, uses and protects your data. Form data, cookies and contact details.`,
  alternates: { canonical: `${verticalConfig.baseUrl}/privacy` },
};

export default function PrivacyPage() {
  const { siteName, companyInfo } = verticalConfig;
