    ...
    <section className="section-padding bg-secondary">
      <div className="container">
        <div className="mx-auto mb-12 max-w-2xl text-center">
          ...
          <h2 className="mb-4 font-display text-3xl font-bold text-foreground md:text-4xl">Recent Projects</h2>
          <p className="mt-2 text-muted-foreground">Recent scaffolding work across domestic and commercial sites.</p>
          <p className="text-muted-foreground">
            These jobs show the mix of planned access, temporary roofing, specialist chimney work, and emergency response we handle.
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {homepageProjects.map((project, index) => (
            <div
              key={project.id}
              className="group overflow-hidden rounded-lg bg-card opacity-0 animate-fade-in"
        ...
        <div className="mt-6 text-center">
          <Button asChild>
            <Link href="/contact">Get a similar scaffolding quote</Link>
          </Button>
        </div>
