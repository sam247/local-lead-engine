...
export const metadata: Metadata = {
  title: `Contact Us | ${verticalConfig.siteName}`,
  description: "Get in touch for a free scaffolding quote — domestic, commercial and specialist scaffolding across the UK.",
  alternates: { canonical: `${verticalConfig.baseUrl}/contact` },
};
...
export default function ContactPage() {
  return (
    <>
      <SchemaMarkup
        type="BreadcrumbList"
        data={{ breadcrumbs: [{ name: "Home", url: "/" }, { name: "Contact", url: "/contact" }] }}
      />
      <section className="bg-primary py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="mb-4 font-display text-4xl font-bold text-primary-foreground md:text-5xl">Contact Us</h1>
            <p className="text-lg text-primary-foreground/80">Get a free, no-obligation scaffolding quote — rapid response.</p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 rounded-lg border p-5">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${companyInfo.email}`} className="text-sm text-muted-foreground hover:text-primary">
                      {companyInfo.email}
                    </a>
                  </div>
                </div>
