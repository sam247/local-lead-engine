...
export const metadata: Metadata = {
  title: "Blog | Mainline Scaffold",
  description: "Expert scaffolding advice, cost guidance, and planning articles from Mainline Scaffold.",
  alternates: { canonical: "https://mainlinescaffold.co.uk/blog" },
};
      ...
      <section className="bg-primary py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-primary-foreground/80">Scaffolding insights, planning advice, and cost guidance.</p>
          </div>
        </div>
      </section>
