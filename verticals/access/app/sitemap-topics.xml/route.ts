...
import { cctvProblemPages, accessControlProblemPages } from "@/data/problemPages";
...
export async function GET() {
  ...
  for (const page of cctvProblemPages) {
    addEntry(`${baseUrl}/cctv-problems/${page.slug}`, "monthly", 0.6);
  }
  for (const page of accessControlProblemPages) {
    addEntry(`${baseUrl}/access-problems/${page.slug}`, "monthly", 0.6);
  }
