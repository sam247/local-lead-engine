...
export const metadata: Metadata = {
  title: `Terms of Use | ${verticalConfig.siteName}`,
  description: `Terms of use for ${verticalConfig.siteName}. Service disclaimers, enquiry model and acceptable use.`,
  alternates: { canonical: `${verticalConfig.baseUrl}/terms` },
};

export default function TermsPage() {
  const { siteName } = verticalConfig;
