...
const RelatedLinks = ({ relatedServices = [], category, currentSlug }: RelatedLinksProps) => {
  ...
  const firstServiceSlug = relatedServices[0] || "access-control-systems";
    ...
    <div className="space-y-6">
      {matchedServices.length > 0 && (
        <div className="rounded-lg bg-secondary p-6">
          <h3 className="mb-4 font-display text-lg font-bold">Related Security Services</h3>
      ...
      {relatedHubs.length > 0 && (
        <div className="rounded-lg bg-secondary p-6">
          <h3 className="mb-4 font-display text-lg font-bold">Security Guides & Resources</h3>
      ...
      <div className="rounded-lg bg-secondary p-6">
        <h3 className="mb-4 font-display text-lg font-bold">Local Security Services</h3>
