                ...
                <NavigationMenuContent>
                  <ul className="grid w-[320px] gap-1 p-4 md:grid-cols-2">
                    ...
                    <li className="col-span-2 border-t border-border pt-1">
                      <NavigationMenuLink asChild>
                        <Link
                          href="/groundworks-contractors-near-me"
            ...
            <div>
              ...
              {locationsOpen && (
                <div className="ml-4 border-l border-border pl-4">
                  ...
                  <Link href="/groundworks-contractors-near-me" className="block py-2 text-sm font-medium text-primary" onClick={() => setMobileMenuOpen(false)}>
                    View All Areas →
                  </Link>
                </div>
              )}
