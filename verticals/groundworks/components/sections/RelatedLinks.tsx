    ...
    <div className="space-y-6">
      {matchedServices.length > 0 && (
        <div className="rounded-lg bg-secondary p-6">
          <h3 className="mb-4 font-display text-lg font-bold">Related Groundworks Services</h3>
      ...
      <div className="rounded-lg bg-secondary p-6">
        <h3 className="mb-4 font-display text-lg font-bold">Local Groundworks Services</h3>
