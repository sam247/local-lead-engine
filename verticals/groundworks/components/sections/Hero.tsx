...
const projectTypeOptions = [
  { id: "new-build", label: "New Build", icon: Ban },
  { id: "extension", label: "Extension", icon: Wind },
  { id: "commercial", label: "Commercial", icon: Droplets },
  { id: "refurb", label: "Refurbishment", icon: TrendingDown },
  ...
  return (
    <section className="relative overflow-hidden bg-primary py-16 md:py-24 lg:py-28">
      <div className="absolute inset-0">
        <img src={heroBg} alt="Groundworks contractors on construction site" className="h-full w-full object-cover opacity-20" />
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                {step === 1 ? (
                  <>
                    ...
                    {/* Project type */}
                    <div>
                      <p className="mb-2 text-xs font-medium text-muted-foreground">What type of project?</p>
                      <div className="grid grid-cols-2 gap-2">
