...
export const metadata: Metadata = {
  title: "Contact Us | Mainline Groundworks",
  description: "Get in touch for a free quote on groundworks, piling, excavation and foundations across the UK.",
  alternates: { canonical: "https://mainlinegroundworks.co.uk/contact" },
};
