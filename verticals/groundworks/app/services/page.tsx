...
export const metadata: Metadata = {
  title: "Our Services | Mainline Groundworks",
  description: "Piling, excavation, site clearance, foundations, concrete foundations and enabling works for commercial and residential projects across the UK.",
      ...
      <section className="bg-primary py-16 md:py-24">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-primary-foreground/80">Groundworks solutions for every project.</p>
          </div>
        </div>
      </section>
