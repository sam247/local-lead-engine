...
/** Legacy wrong-hub paths (cost pages linked under /guides). */
const GUIDE_SLUG_CANONICAL_REDIRECTS: Record<string, string> = {
  "enabling-works-cost": "/groundworks-costs/enabling-works-cost",
};
...
export default function InfoPageRoute({ params }: Props) {
  const legacyRedirect = GUIDE_SLUG_CANONICAL_REDIRECTS[params.slug];
