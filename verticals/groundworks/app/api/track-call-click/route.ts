...
function normalizeInput(body: Record<string, unknown>, req: Request): CallRecord {
  ...
  return {
    ...
    page_path: pagePath,
    source_page_path: trimToString(body.source_page_path) || pagePath,
    service_slug: trimToString(body.service_slug),
    source_service_slug: trimToString(body.source_service_slug) || trimToString(body.service_slug),
    location_slug: trimToString(body.location_slug),
    source_location_slug: trimToString(body.source_location_slug) || trimToString(body.location_slug),
    source_vertical: trimToString(body.source_vertical) || trimToString(body.vertical),
    source_query_theme: trimToString(body.source_query_theme),
