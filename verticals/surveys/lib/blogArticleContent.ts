...
const articleContent: Record<string, BlogArticleContent> = {
  "when-do-you-need-a-topographical-survey": {
    sections: [
      { heading: "Introduction", body: "A topographical survey is one of the most common survey types requested for planning, design and construction. It shows the existing site as it is: levels, boundaries, buildings, services and key features. This guide explains when you need a topographical survey and what you get. For [planning applications](/survey-guides/survey-for-planning-permission), [extensions](/survey-guides/survey-before-building-extension) and [development](/survey-guides/survey-before-property-development), an up-to-date topo survey is usually the first step. Our partners deliver [topographical surveys](/topographical-survey) across London and the South East." },
  ...
  "drone-surveys-vs-traditional-surveys": {
    sections: [
      { heading: "Introduction", body: "Drone surveys are increasingly used for large sites, roof inspections and progress monitoring, but they are not a drop-in replacement for every survey task. This article compares [drone surveys](/drone-survey) with traditional total station and GNSS methods so you can choose the right approach. [How drone surveys work](/survey-guides/how-drone-surveys-work) and [when to use them](/survey-guides/when-to-use-drone-surveys) are covered in our guides." },
  ...
  "survey-requirements-for-planning-permission": {
    sections: [
      { heading: "Introduction", body: "Planning authorities expect accurate information about the existing site. This article outlines typical [survey requirements for planning](/survey-guides/survey-for-planning-permission): topographical surveys, measured building surveys and, where relevant, utility or boundary information. Submitting drawings based on outdated maps is a common cause of delays." },
      { heading: "What planners expect", body: "Most applications need a topographical survey showing levels, boundaries and key features. If you are altering an existing building, a [measured building survey](/measured-building-survey) is often required. Drainage, visibility and access may need to be shown on the same plan. Your architect or planning consultant can confirm local requirements." },
  ...
  "utility-survey-before-excavation": {
    sections: [
      { heading: "Introduction", body: "Striking buried services is dangerous and costly. A [utility survey](/utility-survey) before excavation locates pipes, cables and ducts where detectable, reducing risk and supporting CDM and design. This article explains why you need a utility survey before you dig and what you get." },
      ...
      { heading: "When to commission one", body: "Before piling, groundworks, drainage runs or any significant excavation. For [utility mapping](/utility-mapping-survey) that ties all services to one grid, see our [utility survey cost](/drain-costs/utility-survey-cost) guide." },
    ],
    faqs: [
