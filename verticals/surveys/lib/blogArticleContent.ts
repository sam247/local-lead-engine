...
const articleContent: Record<string, BlogArticleContent> = {
  ...
  "signs-of-drain-collapse": {
    sections: [
      ...
      },
      {
        ...
        body: "Water or sewage backing up into your property, garden, or gullies is a serious sign that the drain is blocked or collapsed. Backups often occur during heavy use or rainfall when the system cannot cope with the volume. Any backup should be treated as urgent: not only is it a health hazard, but it also suggests that the pipe is severely compromised. Emergency [drainage](/services/emergency-drainage) and a follow-up survey will identify whether the cause is a collapse and what repair is needed.",
      },
      {
      ...
      },
      {
        ...
        body: "Unexplained damp patches or areas of grass that stay unusually green (or grow faster than the rest of the lawn) can indicate a leaking or collapsed drain. Wastewater seeping into the soil acts as a fertiliser and a constant source of moisture. If you notice such patches in a line or near where you know the drain runs, it is worth having the pipe inspected. Early detection allows for [targeted repair](/services/drain-collapse-repair) before the problem spreads.",
      },
      {
        heading: "What to Do If You Spot These Signs",
        body: "If you notice one or more of these warning signs, do not ignore them. Book a [CCTV drain survey](/services/cctv-drain-surveys) so that we can inspect the pipe and provide a clear report. From there we can recommend the right solution—whether that is [relining](/services/drain-relining), [excavation](/services/drain-excavation), or another repair method—and give you a fixed quote. For urgent issues such as backups or flooding, our [emergency drainage](/services/emergency-drainage) team is available 24/7.",
      },
    ],
    faqs: [
  ...
  "cctv-drain-survey-guide": {
    sections: [
      {
        heading: "Introduction",
        body: "A CCTV drain survey is an inspection of the inside of your drains using a high-resolution camera. It reveals blockages, cracks, collapses, root ingress, and other defects without any digging. Whether you are buying a property, dealing with recurring [blocked drains](/services/blocked-drains), or planning [drain repair](/services/drain-collapse-repair), a survey gives you the evidence you need to make informed decisions. This guide explains what happens during a CCTV drain survey from start to finish. We carry out [CCTV drain surveys](/services/cctv-drain-surveys) across the UK, including in [Harrow](/cctv-drain-surveys/harrow), [Wimbledon](/cctv-drain-surveys/wimbledon), and [Croydon](/cctv-drain-surveys/croydon).",
      },
      {
      ...
      },
      {
        ...
        body: "The footage shows the internal condition of the pipe: its material, size, and any damage. Common findings include blockages (fat, roots, debris), cracks or fractures, broken or displaced joints, root growth through joints, partial or full collapses, and areas of erosion or deterioration. This information is used to recommend the right fix—whether that is [jetting](/services/drain-jetting), [root removal](/services/drain-root-removal), [relining](/services/drain-relining), or [excavation](/services/drain-excavation)—and to produce an accurate quote.",
      },
      {
        heading: "After the Survey: Your Report",
        body: "You will receive a written report and video footage of the survey. The report typically includes a summary of the condition, the location and description of defects, and recommendations for repair or maintenance. This is valuable for homebuyers (as part of a pre-purchase survey), for insurance claims, and for planning repair work. With the report in hand, you can get fixed-price quotes for any [repairs](/services/drain-collapse-repair) or [relining](/services/drain-relining) that are needed.",
      },
      {
        heading: "Why Book a Survey?",
        body: "Booking a [CCTV drain survey](/services/cctv-drain-surveys) before buying a property can reveal hidden drainage problems and save you from costly surprises. If you already have [slow drains](/services/blocked-drains) or [recurring blockages](/services/drain-unblocking), a survey will identify the cause so that it can be fixed properly rather than repeatedly cleared. For [emergency](/services/emergency-drainage) or planned repair work, a survey ensures we quote accurately and choose the right solution. Contact us to arrange a survey and a clear, detailed report.",
      },
    ],
    faqs: [
  ...
  "preventing-blocked-drains": {
    sections: [
      {
        heading: "Introduction",
        body: "Blocked drains are a common and often avoidable problem. From kitchen sinks to main runs, blockages cause bad smells, slow drainage, and sometimes backups that require [emergency drain unblocking](/services/drain-unblocking). The good news is that many blockages can be prevented with simple habits and occasional maintenance. This guide outlines practical steps you can take at home to keep your drains flowing and reduce the need for [professional unblocking](/services/blocked-drains). If you do run into a stubborn blockage, we offer [drain unblocking](/services/drain-unblocking) and [high-pressure jetting](/services/drain-jetting) across the UK, including in [Uxbridge](/blocked-drains/uxbridge) and [Kingston](/blocked-drains/kingston).",
      },
      {
      ...
      },
      {
        ...
        body: "Fat, oil, and grease solidify as they cool and stick to the inside of pipes. Over time they build up and restrict flow until the drain blocks. Wipe pans and plates with kitchen roll before washing, and put fat and grease in the bin or a sealed container rather than down the sink. Use a sink strainer to catch food scraps and empty it into the bin. These simple steps greatly reduce the risk of [kitchen drain blockages](/services/blocked-drains) and the need for [jetting](/services/drain-jetting) or [unblocking](/services/drain-unblocking).",
      },
      {
        heading: "Bathroom: Use Drain Guards and Only Flush the Right Things",
        body: "Hair and soap can combine to form stubborn blockages in shower and bath wastes. Fit drain guards or hair catchers and clean them regularly. Only flush toilet paper and human waste down the toilet; wet wipes, sanitary products, and other items should go in the bin even if they are labelled \"flushable.\" These products are a major cause of [blocked drains](/services/blocked-drains) and sewer problems. Teaching everyone in the household to follow these rules will cut down on blockages and callouts.",
      },
      {
        heading: "Outside: Keep Gullies and Gutters Clear",
        body: "Gullies and surface water drains can block with leaves, mud, and debris. Clear leaves from gratings and gutters regularly, and avoid washing soil or rubble into gullies. If you have trees near your drain runs, be aware that [roots](/services/drain-root-removal) can invade pipes and cause blockages; a periodic [CCTV survey](/services/cctv-drain-surveys) can spot root ingress before it becomes severe. Keeping external drains clear reduces the chance of backups and flooding.",
      },
      {
        heading: "When Prevention Isn't Enough",
        body: "If you already have a [blockage](/services/drain-unblocking), or if drains are slow despite good habits, the cause may be further down the line—a build-up of grease, roots, or a structural problem. In that case, a [CCTV survey](/services/cctv-drain-surveys) will identify the cause, and we can then [jet](/services/drain-jetting), [clear](/services/drain-unblocking), or recommend [repair](/services/drain-relining) as needed. For urgent blockages or backups, our [emergency drainage](/services/emergency-drainage) team is available 24/7.",
      },
    ],
    faqs: [
  ...
  "tree-root-drain-damage": {
    sections: [
      {
        heading: "Introduction",
        body: "Tree roots are one of the most common causes of drain damage and [blocked drains](/services/blocked-drains). Roots are drawn to the moisture and nutrients inside pipes and can grow through small cracks or loose joints, eventually blocking the flow or breaking the pipe. In this article we look at why roots cause so much damage, how to spot the problem, and what solutions are available. If you suspect root ingress, a [CCTV drain survey](/services/cctv-drain-surveys) will confirm it, and we can then [remove the roots](/services/drain-root-removal) and [reline](/services/drain-relining) the pipe to prevent regrowth. We serve areas including [London](/drain-root-removal/london), [Ealing](/drain-relining/ealing), and [Watford](/drain-root-removal/watford).",
      },
      {
        heading: "Why Tree Roots Get Into Drains",
        body: "Drain pipes carry water and organic matter, so they are an attractive source of moisture and nutrients for tree roots. Older pipes—especially clay with mortar joints—have small gaps at the joints that roots can exploit. Once inside, roots grow quickly in the warm, moist environment and can fill the pipe, causing [blockages](/services/blocked-drains) and eventually cracking or displacing the pipe. Even a single tree some distance away can send roots many metres toward a leaking or damaged drain.",
      },
      {
        heading: "Signs of Root Damage",
        body: "Recurring [blockages](/services/drain-unblocking), slow drainage from multiple fixtures, gurgling sounds, and foul smells can all point to root intrusion. If you have trees near the line of your drain and these symptoms keep coming back after clearing, roots are a likely cause. A [CCTV survey](/services/cctv-drain-surveys) will show the roots inside the pipe and the extent of the damage, so that the right [repair](/services/drain-root-removal) can be planned.",
      },
      {
        heading: "Solutions: Root Removal and Relining",
        body: "Root removal involves cutting and clearing the roots from the pipe, usually with specialist equipment, and then [jetting](/services/drain-jetting) to flush the debris. This restores flow but does not stop roots from growing back unless the entry point is sealed. [Drain relining](/services/drain-relining) creates a seamless new pipe inside the old one, with no joints for roots to penetrate, and is the preferred long-term solution after root removal. In severe cases where the pipe is collapsed or too damaged, [excavation](/services/drain-excavation) and replacement may be needed.",
      },
      {
        heading: "Prevention and Long-Term Care",
        body: "If you are planting new trees, keep them away from known drain runs. For existing trees and drains, periodic [CCTV surveys](/services/cctv-drain-surveys) can detect root ingress early. Once roots have been removed and the pipe [relined](/services/drain-relining), the new liner greatly reduces the chance of regrowth. For advice specific to your property, contact us for a survey and a clear recommendation.",
      },
    ],
    faqs: [
  ...
  "emergency-drainage-what-to-do": {
    sections: [
      {
        heading: "Introduction",
        body: "A drainage emergency—such as sewage backing up, flooding, or a burst or overflowing drain—can be alarming and pose a health risk. Acting quickly and in the right order can limit damage and get the problem under control. This guide outlines what to do in a drainage emergency and how to get professional help fast. Our [emergency drainage](/services/emergency-drainage) team is available 24/7 for urgent callouts across the UK, including [London](/emergency-drainage/london), [Richmond](/emergency-drainage/richmond), and [Slough](/emergency-drainage/slough).",
      },
      {
      ...
      },
      {
        ...
        body: "Drainage emergencies need professional [emergency drainage](/services/emergency-drainage) support. Call a drainage company that offers 24/7 callouts so that an engineer can attend as soon as possible. We will assess the situation, contain the immediate problem (e.g. clear a blockage or pump out water), and advise on next steps. Do not try to clear serious blockages or sewage yourself; the right equipment and expertise are needed to do it safely and effectively.",
      },
      {
        heading: "Step 3: Document the Situation",
        body: "If it is safe to do so, take photos or videos of the problem for insurance or warranty claims. Note the time the issue started and what you have done. This can help with [insurance](/services/drain-collapse-repair) or [warranty](/services/drain-relining) claims and give the engineer useful information when they arrive.",
      },
      {
        heading: "Step 4: Follow-Up Survey and Repair",
        body: "Once the emergency is contained, a [CCTV drain survey](/services/cctv-drain-surveys) will identify the cause—whether it is a [blockage](/services/blocked-drains), [collapse](/services/drain-collapse-repair), [root ingress](/services/drain-root-removal), or something else. From there we can recommend and quote for the right [repair](/services/drain-relining) or [replacement](/services/drain-excavation) so the problem does not recur. Many [emergency callouts](/services/emergency-drainage) are followed by a survey and a planned repair.",
      },
      {
        heading: "When to Treat It as an Emergency",
        body: "Treat it as an emergency if sewage or wastewater is backing up into your property, if there is flooding inside or outside, or if you have no working toilet or drainage and cannot wait for a normal appointment. Our [24/7 emergency team](/services/emergency-drainage) is on hand to respond quickly and get your drainage back under control, then arrange any follow-up [survey](/services/cctv-drain-surveys) and [repair](/services/drain-collapse-repair) you need.",
      },
    ],
    faqs: [
