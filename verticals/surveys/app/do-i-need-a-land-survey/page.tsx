...
const canonicalPath = "/do-i-need-a-land-survey";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `https://mainlinesurveys.co.uk${canonicalPath}` },
};

export default function DoINeedALandSurveyPage() {
  return (
    <>
      <SchemaMarkup type="Article" data={{ title: "Do I Need a Land Survey?", description: "Decision guide for when you need a topographical, measured building, utility or drone survey.", url: canonicalPath }} />
      <SchemaMarkup type="BreadcrumbList" data={{ breadcrumbs: [{ name: "Home", url: "/" }, { name: "Guides", url: "/survey-guides" }, { name: "Do I Need a Land Survey?", url: canonicalPath }] }} />
      ...
      <section id="diagnosis" className="section-padding scroll-mt-24">
        <div className="container">
