...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    "Surveying company pricing guidance with practical cost ranges, quote comparison advice, and local survey service links.";
  return {
    title,
    description,
    alternates: {
...
export default function CompaniesCostPage() {
  ...
  return (
    <CostPageTemplate
      ...
      ctaLinks={ctaLinks}
      relatedLinksTitle="Popular surveying services by location"
