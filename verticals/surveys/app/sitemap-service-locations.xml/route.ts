...
import { generateSurveysServiceLocationStaticParams } from "@/lib/alignedTerritoryGeneration";
...
export async function GET() {
  ...
  for (const { serviceSlug, locationSlug } of generateSurveysServiceLocationStaticParams(
    locations,
    services
  )) {
    entries.push({
